...
<div id="idiomas">
<ul >
<li><a href="index_fr.html" title="Français"><img src="../estilos/imagenes/bandfra.jpg" alt="Français" /></a></li>
<li>|</li> 
<li><a href="../en/index_en.html" title="English"><img src="../estilos/imagenes/banding.jpg" alt="English" /></a></li>
<li>|</li>
...
<li><a href="ciudades.html">Visites des villes</a></li>
<li><a href="itinerario.html">Itinéraires</a></li>
<li><a href="servicios.html">Autres services</a></li>
<li><a href="conocenos.html">Qui sommes-nous?</a></li>
<li><a href="contacto.html"><strong>Contact</strong></a></li>
<li><a href="enlaces.html">Liens</a></li>
...
<div id="titulos"> <h1> Données de contact</h1> </div>
...
<div class="adr">
<div style="text-align: left;"><span class="Apple-style-span" style="font-weight: bold;">Adresse:</span><br></div>
...
<div class="country-name" style="text-align: left;">España</div>  </div>                            
<div class="tel" style="text-align: left;"><span class="type"><strong>Téléphone:</strong></span>(+34) 651 502 507</div>                            
<div style="text-align: left;"><strong>Courrier électronique:</strong> <span class="email">info@amasasturias.com</span></div>  </div> </td>              
<td>                                                           
...
<br />
    ...
    <?php
        ...
        if ($name == "" || $mail == "" || $telf == "" || $text == "") {
            ...
            if (strcmp($ref[0], base64_decode("aHR0cDovL3d3dy5hbWFzYXN0dXJpYXMuY29tL2ZyL2NvbnRhY3RvLmh0bWw="))!=0) {
                echo $errorForm;
                return;
            }
            ...
            $texto = "Consulta en <b>FRANCES</b><br/>\n";
    ...
    ?>
            ...
            <p style="font-weight:bold">La demande vient d'&ecirc;tre envoy&eacute;.</p>
            <p>Nous vous répondrons le plus tôt possible. Merci.</p>
    <?php
    }
    ?>
<br />
...
<div id="piedepagina"> 
<ul><li class="txtpieizq">info@amasasturias.com<br/><a href="politica.html">Politique de confidentialité</a></li>
<li class="txtpieder"><a href="http://www.krismontero.com/" target="_blank">Design: Kris Montero</a><br/><a href="mapaweb.html" >Plan du site</a></li>
</ul>
</div>
</div>
</body></html>
