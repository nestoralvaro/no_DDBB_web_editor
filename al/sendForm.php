...
<li>|</li>
<li><a href="index_al.html" title="Deutsch"><img src="../estilos/imagenes/bandale.jpg" alt="Deutsch" /></a></li>
<li>|</li>
...
<div id="menu">
<ul>
<li><a href="index_al.html">Startseite</a></li>
<li><a href="ciudades.html">Geführte Stadttouren</a></li>
<li><a href="itinerario.html">Routen</a></li>
<li><a href="servicios.html">Weitere Leistungen</a></li>
<li><a href="conocenos.html">Über uns</a></li>
<li><a href="contacto.html"><strong>Kontakt</strong></a></li>
...
<div id="titulos"> <h1> Kontakt</h1> </div>
...
<div class="country-name" style="text-align: left;">Spanien</div>  </div>                            
<div class="tel" style="text-align: left;"><span class="type"><strong>Telefon:</strong></span>(+34) 651 502 507</div>                            
<div style="text-align: left;"><strong>E-mail:</strong> <span class="email">info@amasasturias.com</span></div>  </div> </td>              
<td>                                                           
...
<br />
    ...
    <?php
        ...
        if ($name == "" || $mail == "" || $telf == "" || $text == "") {
            ...
            if (strcmp($ref[0], base64_decode("aHR0cDovL3d3dy5hbWFzYXN0dXJpYXMuY29tL2FsL2NvbnRhY3RvLmh0bWw="))!=0) {
                echo $errorForm;
                return;
            }
            ...
            $texto = "Consulta en <b>ALEMAN</b><br/>\n";
    ...
    ?>
            ...
            <p style="font-weight:bold">Der Antrag wurde gerade gesendet.</p>
...
<div id="piedepagina"> 
<ul><li class="txtpieizq">info@amasasturias.com<br/><a href="politica.html">Datenschutz</a></li>
