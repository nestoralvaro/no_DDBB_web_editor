...
<div id="idiomas">
<ul>
<li><a href="fr/index.html" title="Francés"><img src="../estilos/imagenes/bandfra.jpg" alt="Francés" /></a></li>
<li>|</li> 
<li><a href="in/index.html" title="Inglés"><img src="../estilos/imagenes/banding.jpg" alt="Inglés" /></a></li>
<li>|</li>
<li><a href="al/index.html" title="Alemán"><img src="../estilos/imagenes/bandale.jpg" alt="Alemán" /></a></li>
<li>|</li>
<li><a href="../indexa.html" title="Castellano"><img src="../estilos/imagenes/bandesp.jpg" alt="Castellano" border="0" /></a></li>
</ul>
</div><br />
<div id="general">
...
<li><a href="itinerario.html">Itinerarios</a></li>
...
<div id="titulos"> <h1> Datos de contacto</h1> </div>
<div id="textos" class="monogatari-editor">
<p>Puedes ponerte en contacto con nosotros en:</p>
...
<div class="adr">
<div style="text-align: left;"><span class="Apple-style-span" style="font-weight: bold;">Dirección:</span><br></div>
...
<div class="tel" style="text-align: left;"><span class="type"><strong>Móvil:</strong></span>(+34) 651 502 507</div>                            
<div style="text-align: left;"><strong>Email:</strong> <span class="email">info@amasasturias.com</span></div>  </div> </td>              
<td>                                                           
...
<br />
    ...
    <?php
        ...
        if ($name == "" || $mail == "" || $telf == "" || $text == "") {
            ...
            if (strcmp($ref[0], base64_decode("aHR0cDovL3d3dy5hbWFzYXN0dXJpYXMuY29tL2VzL2NvbnRhY3RvLmh0bWw="))!=0) {
                echo $errorForm;
                return;
            }
            ...
            $texto = "Consulta en <b>CASTELLANO</b><br/>\n";
    ...
    ?>
            ...
            <p style="font-weight:bold">La consulta acaba de ser enviada.</p>
            <p>Atenderemos tu consulta en la mayor brevedad. Gracias</p>
    <?php
    }
    ?>
<br />
...
<div id="piedepagina"> 
<ul><li class="txtpieizq">info@amasasturias.com<br/><a href="politica.html">Política de confidencialidad</a></li>
<li class="txtpieder"><a href="http://www.krismontero.com/" target="_blank">Diseño: Kris Montero</a><br/><a href="mapaweb.html" >Mapa Web</a></li>
</ul>
</div>
</div>
</body></html>
